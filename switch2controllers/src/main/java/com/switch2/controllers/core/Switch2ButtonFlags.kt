...
object Switch2ButtonFlags {
    ...
    const val PLAY_FLAG = 0x0010      // Plus / Start
    const val BACK_FLAG = 0x0020      // Minus / Select
    const val LS_CLK_FLAG = 0x0040    // L3 / Left Stick Click
    const val RS_CLK_FLAG = 0x0080    // R3 / Right Stick Click
    const val SPECIAL_BUTTON_FLAG = 0x0400 // Home / Guide / PS / Xbox
    ...
    const val TOUCHPAD_FLAG = 0x100000
    const val MISC_FLAG = 0x200000 // Capture / Share / Mic
}
